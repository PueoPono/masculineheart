...
const lessons: LessonContent[] = [
  ...
  },
  {
    ...
    practice: "Set a timer for 5-10 minutes and do the meditation outlined in the video. Visualize the string of light between yourself and the center of the earth. Follow it up as you inhale, follow it down as you exhale. Do this for 10 consecutive days to start instilling the effects. Use this visualization as a way to ground yourself anytime.",
    prompts: [],
  ...
  },
  {
    ...
    practice: "Reflection. For 3 days, spend time on what it means to be Creative.\n\n3- Try connecting creativity with the breathe... \"Breathe in creativity... breathe out creativity\". Say to self \"I am creative\", a few times throughout the day (set a reminder).",
    prompts: [
