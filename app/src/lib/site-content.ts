...
const lessons: LessonContent[] = [
  {
    ...
    practice: 'Get a blank note book, download the PDF, and proceed to Day 1.',
    prompts: [
  ...
  },
  {
    ...
    videoSupport: 'Watch the Video, then see the PDF for the emotional fitness training.',
    supportingPoints: [
      '1- Watch the video on identifying emotional pain.',
      '2- Do the emotional fitness exercise in the PDF for Day 1',
      '3- Please wait a day before proceeding to Day 2',
    ],
    integrationHeading: 'Course rhythm',
    integrationBody: 'Please wait a day before proceeding to Day 2.',
    practice: 'Do the emotional fitness exercise in the PDF for Day 1.',
    prompts: [
  ...
  },
  {
    ...
    supportingPoints: [
      'Watch the Video, then see the PDF for the emotional fitness training.',
      '1- Watch the video on identifying sadness',
      '2- Do the emotional fitness exercise in the PDF for Day 2',
    ...
    practice: 'Do the emotional fitness exercise in the PDF for Day 2.',
    prompts: [
  ...
  },
  {
    ...
    supportingPoints: [
      ...
      '2- Do the emotional fitness exercise in the PDF for Day 3',
    ...
    practice: 'Do the emotional fitness exercise in the PDF for Day 3.',
    prompts: [
  ...
  },
  {
    ...
    supportingPoints: [
      ...
      '2- Do the emotional fitness exercise in the PDF for Day 4',
    ...
    practice: 'Do the emotional fitness exercise in the PDF for Day 4.',
    prompts: [
  ...
  },
  {
    ...
    supportingPoints: [
      ...
      '2- Do the emotional fitness exercise in the PDF for Day 5',
    ...
    practice: 'Do the emotional fitness exercise in the PDF for Day 5.',
    prompts: [
  ...
  },
  {
    ...
    supportingPoints: [
      ...
      '2- Do the emotional fitness exercise in the PDF for Day 6',
    ...
    practice: 'Do the emotional fitness exercise in the PDF for Day 6.',
    prompts: [
  ...
  },
  {
    ...
    supportingPoints: [
      ...
      '2- Do the emotional fitness exercise in the PDF for Day 7',
    ...
    practice: 'Do the emotional fitness exercise in the PDF for Day 7 and fill out the questionnaire.',
    prompts: [
  ...
  },
  {
    ...
    videoLabel: 'Language Of The Heart · Part 1 of Iron John',
    ...
    supportingPoints: [
      'Part 1 of the Story of Iron John',
...
export const defaultSiteContent: SiteContent = {
  ...
  portal: {
    ...
    trackDaysLabels: ['Intro + Days 1–7', 'Intro + Days 1–8', 'Intro + Intentions 1–7 + Summary'],
...
export const courseTracks: CourseTrack[] = [
  ...
  },
  {
    ...
    daysLabel: 'Intro + Intentions 1–7 + Summary',
